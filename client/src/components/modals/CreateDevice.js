            ...
            <Modal.Body>
                <Form>
                    ...
                    <Form.Control
                        ...
                        className="mt-3"
                        placeholder={"Input new device price"}
                        type="number"
                    />
                    <Form.Control
                        className="mt-3"
                    ...
                    />
                    <hr />
                    <Button variant="outline-dark" onClick={addInfo}>Add new spec</Button>
                    {
                        info.map(i =>
                        <Row className="mt-3" key={i.number}>
                            <Col md={4}>
                                <Form.Control
                                    ...
                                    placeholder="Input spec title"/>
                            </Col>
                            <Col md={4}>
                                <Form.Control
                                    value={i.description}
                                    onChange={(e) => changeInfo('description', e.target.value, i.number)}
                                    placeholder="Input spec description"/>
                            </Col>
                            <Col md={4}>
                                <Button
